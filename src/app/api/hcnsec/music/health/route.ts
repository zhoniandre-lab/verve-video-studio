...
const CEK: { id: string; label: string; url: string; body?: any }[] = [
  ...
  { id: "musicapi", label: "MusicAPI", url: "https://api.musicapi.ai/api/v1/sonic/create", body: { custom_mode: false, gpt_description_prompt: "p", mv: "sonic-v5" } },
  { id: "aimusicapi", label: "AIMusicAPI", url: "https://api.aimusicapi.ai/api/v1/suno/create", body: { custom_mode: false, gpt_description_prompt: "p", mv: "chirp-v5" } },
