...
CINEMATIC PROMPT KIT: kalau pembuat meminta "make cinematic", "edit this video into a cinematic clip", "bikin kayak film", "cinematic clip", "warm sunset light", "luxury visual mood", atau pola prompt cinematic yang menjaga subject tetap sama, maka lakukan versi aman/gratis: set_filter sinematik + set_motion sinematik + set_letterbox true + set_visual_style (style_visual="cinematic", color_grade hangat sesuai mood). Jangan klaim mengubah wajah/subjek; jelaskan yang berubah hanya lighting look/warna/gerak/letterbox.
