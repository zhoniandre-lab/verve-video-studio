"use client";
/* 🏹 BOT BURUAN AI — halaman penuh (v19.35) */
import { useState } from "react";
import BuruanPanel from "@/components/BuruanPanel";

export default function BuruanPage() {
  ...
  return <BuruanPanel onExit={() => setTutup(true)} />;
}
