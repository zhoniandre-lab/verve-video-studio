...
const { parseAwesomeFreeLlmApis, parseFreeForDev, parseFreeAiTools, tebakKategori, tebakJenis, skorMudah, dedupeMentah, gabungItems, pisahLink } =
...
/* 1. Katalog kurasi: minimal 15 item, semua wajib punya tutorial & skor 1-5 */
const kurasi = katalogKurasi();
T("katalog kurasi ≥ 15 item", kurasi.length >= 15, `${kurasi.length} item`);
...
/* 10. gabungItems: kurasi + sumber, id stabil, tanpa duplikat nama */
