...
// 9) production helpers: 3 varian + upload kit
{
  ...
  const kit = prod.makeUploadKitText({ title: "Doa Ibu", description: "desc", tags: ["ibu", "lagu"], hashtags: "#doaibu", hasVideo: true, checklist, sources: [{ scene: 1, provider: "pexels", by: "Ari · Pexels", id: 77, link: "https://pexels.test/v" }] });
