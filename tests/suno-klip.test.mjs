...
T("Spectrum pakai url terpilih saja", /JANGAN gabung/.test(spec) || /rute \"hasil Suno dari \/suno \u2192 Spectrum\" DIHAPUS/.test(spec));
T("Spectrum tidak terima hasil Suno dari /suno (v19.85)", !/verve_suno_hasil/.test(spec));
