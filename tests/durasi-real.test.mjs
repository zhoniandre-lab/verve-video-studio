...
T("SunoStudio decode SEKALI dan buat WAV dari buffer itu", /const dek = langsung/.test(studio) && /bufferToWav\(mono\)/.test(studio));
...
T("Lahan ukur durasi REAL saat lagu jadi", /ukurDurasiReal\(res\.url/.test(lahan));
T("Lahan probeSongDur decode dulu", /ukurDurasiReal\(url/.test(lahan));
T("Lahan restore draft lama ukur ulang", /ukurDurasiReal\(rs\.url/.test(lahan));
