...
## v13.35 SERAH-TERIMA ANTI-BASI (2026-07-25)
Keluhan bro: jalur wizard (riset→step→buat video) masuk studio malah kebuka proyek/setelan LAMA; jalur langsung aman. Bedah statis jalan simpan→gotoEditor→applySnapshot tampak benar & jujur kuakui: biang pasti belum 100% terbukti dari jauh. Mode gagal yang MAMPU bikin fenomena itu: simpan localStorage gagal diam-diam (QuotaExceeded ditelan catch → wizard tetap flash sukses?? tidak — tapi gotoEditor terlewat) ATAU draf tak ketemu tanpa satu kata pun. Kunci keras: (1) wizard WAJIB bukti-tulis (baca-ulang; id proyek baru tidak tercatat → throw jujur "memori penuh? hapus draf lama", TIDAK mengantar ke studio); (2) studio MENYEBUT NAMA proyek yang dibuka (flash "📂 Proyek dibuka: …") + peringatan jelas bila tak ketemu. Hasil: serah-terima bisa diverifikasi mata — kalau proyek lama masih kebuka, namanya kelihatan & bisa difoto, misteri selesai tanpa tebakan. Gerbang: tsc 0, build 0, 6 suite ✅, smoke ✓.
